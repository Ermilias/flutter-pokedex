              ...
              child: Column(
                children: <Widget>[
                  ...
                  ListTile(
                      ...
                      trailing: Text(
                          pokemon.id,
                          style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 30, fontWeight: FontWeight.bold)
                      )
                  ),
                  Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                      ...
                      subtitle: Text(
                          pokemon.description,
                          style: TextStyle(color: Colors.black.withOpacity(0.8), fontSize: 18, fontStyle: FontStyle.italic)
                      ),
                  ),
                  Padding(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: getColor(pokemon.types[index].toLowerCase()).withOpacity(0.5),
                            ),
                            child: Center(child:Text(pokemon.types[index], textAlign: TextAlign.center))
                        );
                      },
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  Text(
                      'HP',
                      style: TextStyle(color: Colors.black.withOpacity(0.5), fontSize: 18, fontStyle: FontStyle.italic)
                  ),
                  SizedBox(width: 60),
                  Text(
                      pokemon.hp.toString(),
                  ...
                  SizedBox(
                      ...
                      child:  ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            backgroundColor: colorFromType(pokemon.types).withOpacity(0.3),
                            valueColor: AlwaysStoppedAnimation<Color>(colorFromType(pokemon.types)),
